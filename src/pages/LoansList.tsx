...
const LoansList = () => {
  ...
  const fetchLoans = async () => {
    ...
    try {
      ...
      const [tabCounts, { data, count }] = await Promise.all([
        fetchPrestamosCounts(cobradorId),
        fetchPrestamos(
          { page, pageSize },
          {
            searchTerm,
  ...
  return (
    <Layout
      title="Préstamos"
      subtitle={`${loans.length} préstamos registrados`}
    >
      {/* SEARCH */}
                ...
                >
                  ...
                  <div className="loan-card-header">
                    <div className="loan-client">
                      ...
                      <div>
                        <div className="loan-client-name">
                  ...
                  <div className="loan-stats-row">
                    ...
                    <div className="loan-stat-block">
                      ...
                      <span className="loan-stat-val highlight">
